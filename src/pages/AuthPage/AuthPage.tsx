  ...
  const onFinished = (isRenewPassword: boolean) => {
    switch (authType) {
      case AuthFlowType.SignIn:
        signInMutation.mutate(isRenewPassword);
        break;
  ...
  return (
    <>
      <PasscodeDialog
        ...
        onOpenChange={newValue => setShowPasscodeModal(newValue)}
          ...
          <div className="lg:p-8">
            <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
              <div className="flex flex-col space-y-2 text-center">
                <h1 className="text-2xl font-semibold tracking-tight">Continue to QueueOverflow</h1>
