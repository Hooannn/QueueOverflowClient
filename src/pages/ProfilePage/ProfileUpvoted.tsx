...
export default function ProfileUpvoted() {
  ...
  const getUpvotedPostsQuery = useQuery({
    queryKey: ['fetch/upvotedPosts', id, query],
    queryFn: () => axios.get<IResponseData<Post[]>>(`/v1/posts/upvoted`, { params: query }),
  ...
  const posts = getUpvotedPostsQuery.data?.data.data;
  return (
    <>
      ...
      <div className="w-full">
        {getUpvotedPostsQuery.isLoading ? (
